...
เหตุผล: ใช้ AI ช่วยร่างโครงสร้างเริ่มต้นของ `productApi.js` และ middleware บางตัว แต่ได้อ่าน ปรับแก้
และทดสอบทุกบรรทัดด้วยตนเอง รวมถึงเขียน logic validation, การจัดการ state ใน `App.jsx`
และการ debug ปัญหา CORS ด้วยตัวเอง
